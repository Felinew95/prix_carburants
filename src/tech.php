<?php 
    ...
    /**
     * Page de démonstration technique du site internet OùFaireLePlein
     * 
     * Module hybride combinant l'API Studio Ghibli et l'API Geolocation.
     * - Récupération et filtrage des données cinématiques (Ghibli).
     * - Calcul de proximité basé sur les coordonnées GPS de l'utilisateur.
     * 
     * @author Alexandre 
     * @author Tauseef
     * 
    ...
    /**
     * @var Film Informations du film aléatoire
     */
    $infosFilmAleatoire = getInfosFilm();
    
    /**
     * @var Visiteur Informations du visiteur
     */
...
?>
        ...
        <section class="infos-API">
            <h1>Page Technique - Démonstration API</h1>
        ...
        <section>
            <?php 
            $data = file_get_contents('https://data.economie.gouv.fr/api/explore/v2.1/catalog/datasets/prix-des-carburants-en-france-flux-instantane-v2/records');
