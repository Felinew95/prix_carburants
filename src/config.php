<?php
    ...
    /**
     * @var array Tableau des articles définis par département
     */
    const ARTICLES_DEPARTEMENTS = [
        "le" => [
           "Calvados", "Cantal", "Cher", "Doubs", "Finistère", "Gard", 
           "Gers", "Jura", "Loir-et-Cher", "Loiret", "Lot", "Lot-et-Garonne",
           "Maine-et-Loire", "Meurthe-et-Moselle", "Morbihan", "Nord", 
           "Pas-de-Calais", "Puy-de-Dôme", "Bas-Rhin", "Haut-Rhin", "Rhône",
           "Tarn", "Tarn-et-Garonne", "Var", "Vaucluse", "Territoire de Belfort",
           "Val-de-Marne", "Val-d'Oise"
        ],
    
        "la" => [
            "Charente", "Charente-Maritime", "Corrèze", "Corse-du-Sud", "Haute-Corse", 
            "Côte-d'Or", "Creuse", "Dordogne", "Drôme", "Haute-Garonne", "Gironde", "Loire",
            "Haute-Loire", "Loire-Atlantique", "Lozère", "Manche", "Marne", "Haute-Marne",
            "Mayenne", "Meuse", "Moselle", "Nièvre", "Haute-Saône", "Saône-et-Loire", "Sarthe",
            "Savoie", "Haute-Savoie", "Seine-Maritime", "Seine-et-Marne", "Somme", "Vendée", "Vienne",
            "Haute-Vienne", "Seine-Saint-Denis"
        ],
    
        "l'" => [
           "Ain", "Aisne", "Allier", "Ardèche", "Ariège", "Aube", "Aude", "Aveyron",
           "Eure", "Eure-et-Loir", "Hérault", "Ille-et-Vilaine", "Indre", "Indre-et-Loire",
           "Isère", "Oise", "Orne", "Yonne", "Essonne"
        ],
    
        "les" => [
            "Alpes-de-Haute-Provence", "Hautes-Alpes", "Alpes-Maritimes", "Ardennes",
            "Bouches-du-Rhône", "Côtes-d'Armor", "Landes", "Pyrénées-Atlantiques",
            "Hautes-Pyrénées", "Pyrénées-Orientales", "Yvelines", "Deux-Sèvres", 
            "Vosges", "Hauts-de-Seine"
        ],
    ...
    /**
     * @var array Tableau des zones géographiques par région
     */
    const ZONES_REGIONS = [
        "Nord" => [
            "Hauts-de-France",
    ...
    /**
     * @var string Fichier texte du nombre total de visites du site
     */
    const FICHIER_NOMBRE_VISITES_TOTALES_TOUS_UTILISATEURS = __DIR__."/cache/nombreVisitesTotalesTousUtilisateurs.txt";

    /**
     * @var int Limite du nombre de consultations des visiteurs 
     */
    const LIMITE_NOMBRE_VISITEURS_CONSULTATION = 1_000_000;
