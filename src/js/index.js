...
function getElementsToSaveScrollPosition() {
    const validerRegion = document.getElementById("franceMap");
    ...
    if (validerRegion) {
        validerRegion.addEventListener("click", () => {
            saveScrollPosition("scrollPosition");
        });
    }

    if (validerDepartement) {
        validerDepartement.addEventListener("click", () => {
            saveScrollPosition("scrollPosition");
        });
    }

    if (validerVille) {
        validerVille.addEventListener("click", () => {
            saveScrollPosition("scrollPosition");
        });
    }
}
