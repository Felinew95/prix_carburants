<?php
    ...
    session_start(); // Démarre une nouvelle session via l'identifiant de session passé dans une requête GET, POST ou par un cookie.
    ...
    $informationsCarburants = ['gazole' => ['libelle' => 'Gazole', 'couleur' => '#f59e0b'],
        'sp95'   => ['libelle' => 'SP95',   'couleur' => '#3b82f6'],
        'sp98'   => ['libelle' => 'SP98',   'couleur' => '#ef4444'],
        'e10'    => ['libelle' => 'E10',    'couleur' => '#10b981'],
    ];
...
?>
        ...
        <section class="bloc-statistiques">
            ...
            <div class="grille-prix-carburants">
                ...
                <div class="carte-prix">
                    <div class="carte-prix-libelle" style="color: <?= $infos['couleur'] ?>">
                        <?= $infos['libelle'] ?>
                    </div>
                    <div class="carte-prix-valeur" style="color: <?= $infos['couleur'] ?>">
            ...
            <div class="conteneur-tableau-comparaison">
                <table class="tableau-comparaison">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <span class="puce-couleur" style="background: <?= $infos['couleur'] ?>"></span>
                                <?= $infos['libelle'] ?>
                            </td>
    ...
    <?php else: ?>
        ...
        <section class="bloc-statistiques">
            <h2 class="titre-section">Statistiques France métropolitaine</h3>
