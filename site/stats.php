<?php
    ...
    if ($objetVille !== null) {
        ...
        enregistrerVilleCSV(
            FICHIER_CACHE_VILLES_CONSULTES_MENSUEL, $objetVille, TEMPS_CACHE_VILLES_CONSULTES_MENSUEL
        );
    }
    ...
    $villesPlusRecherchesAnnuel= getVillesRecherchesCSV(FICHIER_CACHE_VILLES_CONSULTES_ANNUEL);
    $villesPlusRecherchesMensuel = getVillesRecherchesCSV(FICHIER_CACHE_VILLES_CONSULTES_MENSUEL);
    ...
    <?php if ($objetVille !== null): ?>
        <section class="bloc-statistiques">
            <h2 class="titre-section">
                ...
                Stations par ville — Proche de <?= htmlspecialchars($objetVille->getNom()) ?>
            </h2>
