<?php
    ...
    function enregistrerVilleCSV(string $fichier, Ville $ville, int $tempsCache) : void {
        ...
        renitialiserCSV($fichier, $tempsCache);
     ...
     */
    function getVillesRecherchesCSV(string $cheminFichier) : array {
    ...
    */
    function creerListeVillesLesPlusRecherches(array $villes) : string {
        ...
        foreach ($villes as $nomVille => $info) {
            $liste .= "<li>" . htmlspecialchars($nomVille) . " (" . htmlspecialchars($info['departement']) . ", " 
                . htmlspecialchars($info['region']) . ") - " . $info['nombre'] . " consultations</li>";
        }
